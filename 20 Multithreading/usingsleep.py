...
class MyThread:
    def displayNumbers(self):
        ...
        time.sleep(2)                # This puts the current thread into sleep for 2 seconds             Output: First, names of all the threads is outputted then the threads starts executing according to python thread scheduler
        while i<=10:
            print(i)
            i+=1
